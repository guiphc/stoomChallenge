...
import Dought from '../components/steps/Dought'
...
export default function Index() {
  ...
  const commonProps = { classes, handleNext, handleBack, handleReset, activeStep }

  const renderStep = [<Dought {...commonProps} />, <>teste2</>]
